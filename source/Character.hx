	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pico':
				...
				flipX = true;
			case 'bob':
				tex = Paths.getSparrowAtlas('Pico_FNF_assetss2');
				frames = tex;
				animation.addByPrefix('idle', "bob Idle Dance", 24);
				animation.addByPrefix('singUP', 'bob Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'bob Down Note0', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'bob NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'bob Note Right0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'bob Note Right Miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'bob NOTE LEFT miss', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'bob Note Right0', 24, false);
					animation.addByPrefix('singRIGHT', 'bob NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'bob NOTE LEFT miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'bob Note Right Miss', 24, false);
				}

				animation.addByPrefix('singUPmiss', 'bob Up note miss', 24);
				animation.addByPrefix('singDOWNmiss', 'bob Down Note MISS', 24);
			...
			case 'bob2':
				tex = Paths.getSparrowAtlas('Pico_FNF_assetss3');
				frames = tex;
				animation.addByPrefix('idle', "bob2 Idle Dance", 24);
				animation.addByPrefix('singUP', 'bob2 Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'bob2 Down Note0', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'bob2 NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHT', 'bob2 Note Right0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'bob2 Note Right Miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'bob2 NOTE LEFT miss', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'bob2 Note Right0', 24, false);
					animation.addByPrefix('singRIGHT', 'bob2 NOTE LEFT0', 24, false);
					animation.addByPrefix('singRIGHTmiss', 'bob2 NOTE LEFT miss', 24, false);
					animation.addByPrefix('singLEFTmiss', 'bob2 Note Right Miss', 24, false);
				}

				animation.addByPrefix('singUPmiss', 'bob2 Up note miss', 24);
				animation.addByPrefix('singDOWNmiss', 'bob2 Down Note MISS', 24);
